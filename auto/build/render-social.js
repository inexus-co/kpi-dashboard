...
<div class="wrap">
  ...
  <!-- F. 動画一覧 -->
  <div class="section-label">動画別 実績一覧 <span class="hint">累計の再生数・いいね・コメント／7日の再生増分／エンゲージ率</span></div>
  <div class="card full">
...
(function(){
  ...
  document.getElementById("vidRows").innerHTML = D.table.slice(0,15).map(row).join("");
  const rest = D.table.slice(15);
  if (rest.length) {
