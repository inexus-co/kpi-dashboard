...
node $B/build-saiten.js $B/templates/saiten-artifact.html $C/slack_archive/C08R1MRSXDF.txt $C/saiten-inner.html "$NOW"
...
tar -c -C auto cache/slack_archive/C08R1MRSXDF.txt cache/slack_archive/C08R1MRSXDF.meta.json | openssl enc -aes-256-cbc -pbkdf2 -iter 200000 -k "$CACHE_KEY" -out auto/cache-saiten.enc
